...
contract BlackList is MinterRole {
    ...
    function addBlackList (address _evilUser) public onlyMinter {
        isBlackListed[_evilUser] = true;
        emit AddedBlackList(_evilUser);
    }

    function removeBlackList (address _clearedUser) public onlyMinter {
